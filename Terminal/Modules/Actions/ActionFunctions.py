...
from Terminal.Modules import MapManager, Movement, OpenLib
from Terminal.Modules.Actions import Action, ActionRequirementsCheckers
from Terminal.Modules import NPCInteraction
from Terminal.Modules.NPCInteraction import NPCAction
...
def ExchangeTrashItemsToEnergyFragments(args):
    from Terminal.Modules import Settings
