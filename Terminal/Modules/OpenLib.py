_chr=chr
from Terminal.Modules.Hooks import Hook, questHook
import Hooks, Data
import ui,chr,time,app, net, background, player,wndMgr,math,snd,eXLib,uiToolTip,item,FileManager,event,chat,OpenLog,skill
...
def isInventoryFull():
	global player
	INV_FULL_MIN_EMPTY = 1
	MAX_INVENTORY_SIZE = int(player.GetExtendInvenMax())
	"""
