...
class Component:
	...
	def OnOffButton(self,parent,buttonName, tooltipText,x,y,image=None,OffUpVisual=eXLib.PATH + 'Terminal/Images/off_0.tga', OffOverVisual=eXLib.PATH + 'Terminal/Images/off_1.tga', OffDownVisual=eXLib.PATH + 'Terminal/Images/off_2.tga',OnUpVisual=eXLib.PATH + 'Terminal/Images/on_0.tga', OnOverVisual=eXLib.PATH + 'Terminal/Images/on_1.tga', OnDownVisual=eXLib.PATH + 'Terminal/Images/on_2.tga',xImgOffset = 15,yImgOffset = 15,funcState=None,defaultValue=0):
		if image != None:
