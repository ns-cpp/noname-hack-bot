...
CONFIG_MAP_NPCS = eXLib.PATH + 'Terminal/Saves/NpcMaps/'
CONFIG_MAP_LINKS = eXLib.PATH + 'Terminal/Saves/map_linker.txt'


CONFIG = eXLib.PATH + 'Terminal/Saves/config.bot'
CONFIG_PRICE = eXLib.PATH + 'Terminal/Saves/priceconfig.bot'
CONFIG_SKILLBOT = eXLib.PATH + 'Terminal/Saves/skillbot.bot'
CONFIG_BOSSES_ID = eXLib.PATH + 'Terminal/Saves/boss_ids.txt'
CONFIG_ORES_ID = eXLib.PATH + 'Terminal/Saves/ores_ids.txt'
CONFIG_PSHOP_AUTO_BUY = eXLib.PATH + 'Terminal/Saves/search_items_max_price.txt'
CONFIG_PICKUP_FILTER = eXLib.PATH + 'Terminal/Saves/pickup_filter.txt'
CONFIG_SHOP_CREATOR = eXLib.PATH + 'Terminal/Saves/item_sell_prices.txt'
CONFIG_SELL_INVENTORY = eXLib.PATH + 'Terminal/Saves/items_to_sell.txt'
CONFIG_LOCATION_CHANGER = eXLib.PATH + 'Terminal/Saves/location_changer.txt'
CONFIG_FARMBOT_SETTINGS = eXLib.PATH + 'Terminal/Saves/farmbot.bot'
SHOP_CREATOR_LOG = eXLib.PATH + 'Terminal/Saves/shop_log.txt'
FARMBOT_WAYPOINTS_LISTS = eXLib.PATH + 'Terminal/Saves/Paths/'
ACTIONS_LISTS = eXLib.PATH + 'Terminal/Saves/Actions/'
