...
class LevelBotDialog(BotBase):
	...
	def BuildWindow(self):
		...
		self.EnableButton = comp.OnOffButton(self.Board, '', '', 0,323,OffUpVisual=eXLib.PATH + 'Terminal/Images/start_0.tga', OffOverVisual=eXLib.PATH + 'Terminal/Images/start_1.tga', OffDownVisual=eXLib.PATH + 'Terminal/Images/start_2.tga',OnUpVisual=eXLib.PATH + 'Terminal/Images/stop_0.tga', OnOverVisual=eXLib.PATH + 'Terminal/Images/stop_1.tga', OnDownVisual=eXLib.PATH + 'Terminal/Images/stop_2.tga',funcState=self.OnStartStop)
